...
import '../../api/data_source/signup/remote_data_source/signup_remote_data_source_impl.dart'
    as _i354;
import '../../api/data_source/subjects/subjects_remote_data_source_impl.dart'
    as _i170;
...
import '../../data/data_source/signup/remote_data_source/signup_remote_data_source.dart'
    as _i879;
import '../../data/data_source/subjects/subject_remote_data_source.dart'
    as _i539;
...
import '../../data/repositories/subjects/subject_repository_impl.dart' as _i293;
...
import '../../domain/repositories/subjects/subject_repository.dart' as _i597;
...
import '../../domain/use_cases/subjects/subject_use_case.dart' as _i617;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.factory<_i539.SubjectRemoteDataSource>(
        () => _i170.SubjectsRemoteDataSourceImpl(gh<_i508.ApiClient>()));
    ...
    gh.factory<_i597.SubjectRepository>(() => _i293.SubjectRepositoryImpl(
        subjectRemoteDataSource: gh<_i539.SubjectRemoteDataSource>()));
    ...
    gh.factory<_i617.SubjectUseCase>(
        () => _i617.SubjectUseCase(gh<_i597.SubjectRepository>()));
    ...
    gh.factory<_i69.HomeCubit>(
        () => _i69.HomeCubit(subjectUseCase: gh<_i617.SubjectUseCase>()));
